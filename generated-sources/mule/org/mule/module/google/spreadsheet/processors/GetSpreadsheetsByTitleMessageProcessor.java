    ...
    implements MessageProcessor, OperationMetaDataEnabled
{
    ...
    public GetSpreadsheetsByTitleMessageProcessor(String operationName) {
        super(operationName);
    }
        ...
        throws Exception
    {
        ...
        try {
            ...
            final String _transformedTitle = ((String) evaluateAndTransform(getMuleContext(), event, GetSpreadsheetsByTitleMessageProcessor.class.getDeclaredField("_titleType").getGenericType(), null, title));
            ...
            resultPayload = processTemplate.execute(new ProcessCallback<Object,Object>() {
                ...
                public Object process(Object object)
                    throws Exception
                {
                    return ((GoogleSpreadSheetConnector) object).getSpreadsheetsByTitle(_transformedTitle);
                }
    ...
    public Result<MetaData> getOutputMetaData(MetaData inputMetadata) {
        return new DefaultResult<MetaData>(new DefaultMetaData(new DefaultListMetaDataModel(getPojoOrSimpleModel(Spreadsheet.class))));
    }
        ...
        try {
            ...
            try {
                ...
                if (metadata.get() == null) {
                    return new DefaultResult<MetaData>(null, (Result.Status.FAILURE), "There was an error processing metadata at GoogleSpreadSheetConnector at getSpreadsheetsByTitle retrieving was successful but result is null");
                }
                return metadata;
            } catch (Exception e) {
