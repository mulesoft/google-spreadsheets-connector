    ...
    implements MessageProcessor, OperationMetaDataEnabled
{
    ...
    public CreateSpreadsheetMessageProcessor(String operationName) {
        super(operationName);
    }
        ...
        try {
            ...
            processTemplate.execute(new ProcessCallback<Object,Object>() {
                ...
                public Object process(Object object)
                    throws Exception
                {
                    ((GoogleSpreadSheetConnector) object).createSpreadsheet(_transformedTitle);
                    return null;
                }
        ...
        try {
            ...
            try {
                ...
                if (metadata.get() == null) {
                    return new DefaultResult<MetaData>(null, (Result.Status.FAILURE), "There was an error processing metadata at GoogleSpreadSheetConnector at createSpreadsheet retrieving was successful but result is null");
                }
                return metadata;
            } catch (Exception e) {
