 ...
 */
@Connector(name = "google-spreadsheets", schemaVersion = "1.0", friendlyName = "Google Spreadsheets", minMuleVersion = "3.5", configElementName = "config-with-oauth") @OAuth2(friendlyName = "OAuth 2.0",
        ...
        authorizationParameters = {
                ...
                @OAuthAuthorizationParameter(name = "force_prompt", defaultValue = "auto", type = ForcePrompt.class, description =
                        "Indicates if google should remember that an app has been authorized or if each should ask authorization every time. "
                                + " Use force to request authorization every time or auto to only do it the first time. Default is auto", optional = true) }) @ReconnectOn(exceptions = OAuthTokenExpiredException.class) public class GoogleSpreadSheetConnector
    ...
    @Processor
    @OAuthProtected
    public Worksheet createWorksheet(String spreadsheet, @Default("0") int spreadsheetIndex, String title, int rowCount, int colCount) throws IOException, ServiceException {
    ...
    @Processor
    @OAuthProtected
    public void deleteWorksheet(String spreadsheet, String worksheet, @Default("0") int spreadsheetIndex, @Default("0") int worksheetIndex) throws IOException, ServiceException {
    ...
    @Processor
    @OAuthProtected
    public void updateWorksheetMetadata(String spreadsheet, String worksheet, @Default("") String title, @Optional Boolean draft, @Optional Boolean canEdit,
            @Default("") String summary, @Default("0") int rowCount, @Default("0") int colCount, @Default("0") int spreadsheetIndex, @Default("0") int worksheetIndex)
    ...
    @Processor
    @OAuthProtected
    public void setRowValues(@Default("#[payload]") List<Row> rows, String spreadsheet, String worksheet, @Default("0") int spreadsheetIndex, @Default("0") int worksheetIndex,
    ...
    @Processor
    @OAuthProtected
    public void setCsvValues(String spreadsheet, String worksheet, @Default("#[payload]") String csv, @Default("1") int startingRow, @Default("1") int startingColumn,
            @Default("\n") String lineSeparator, @Default(",") String columnSeparator, @Default("0") int spreadsheetIndex, @Default("0") int worksheetIndex,
            @Default("false") boolean purge) throws Exception {
    ...
    @Processor
    @OAuthProtected
    public Row getColumnHeaders(String spreadsheet, String worksheet, @Default("0") int spreadsheetIndex, @Default("0") int worksheetIndex) throws IOException, ServiceException {
    ...
    @Processor
    @OAuthProtected
    public List<Worksheet> getWorksheetByTitle(String spreadsheet, String title, @Default("0") int spreadsheetIndex) throws IOException, ServiceException {
    ...
    @Processor
    @OAuthProtected
    public void purgeWorksheet(String spreadsheet, String worksheet, @Default("0") int spreadsheetIndex, @Default("0") int worksheetIndex) throws IOException, ServiceException {
    ...
    @Processor
    @OAuthProtected
    public List<Row> getAllCells(String spreadsheet, String worksheet, @Default("0") int spreadsheetIndex, @Default("0") int worksheetIndex) throws IOException, ServiceException {
    ...
    @Processor
    @OAuthProtected
    public String getAllCellsAsCsv(String spreadsheet, String worksheet, @Default(",") String columnSeparator, @Default("\n") String lineSeparator,
            @Default("0") int spreadsheetIndex, @Default("0") int worksheetIndex) throws IOException, ServiceException {
        ...
        return ModelParser.toCSV(this.getAllCells(spreadsheet, worksheet, spreadsheetIndex, worksheetIndex), lineSeparator, columnSeparator);
    }
    ...
    @Processor
    @OAuthProtected
    public List<Row> getCellRange(String spreadsheet, String worksheet, @Default("0") int spreadsheetIndex, @Default("0") int worksheetIndex, @Optional Integer minRow,
            @Optional Integer maxRow, @Optional Integer minCol, @Optional Integer maxCol) throws IOException, ServiceException {
    ...
    @Processor
    @OAuthProtected
    public String getCellRangeAsCsv(String spreadsheet, String worksheet, @Default("0") int spreadsheetIndex, @Default("0") int worksheetIndex,
            @Default(",") String columnSeparator, @Default("\n") String lineSeparator, @Optional Integer minRow, @Optional Integer maxRow, @Optional Integer minCol,
        ...
        List<Row> rows = this.getCellRange(spreadsheet, worksheet, spreadsheetIndex, worksheetIndex, minRow, maxRow, minCol, maxCol);
    ...
    @Processor
    @OAuthProtected
    public List<Row> search(String spreadsheet, String worksheet, String query, @Default("0") int spreadsheetIndex, @Default("0") int worksheetIndex)
            throws IOException, ServiceException {
    ...
    private SpreadsheetEntry getSpreadsheetEntry(String spreadsheet, int spreadsheetIndex) throws IOException, ServiceException {
    ...
    private List<WorksheetEntry> getWorksheetEntriesByTitle(String spreadsheet, String worksheet, int spreadsheetIndex) throws IOException, ServiceException {
    ...
    private WorksheetEntry getWorksheetEntry(String accessToken, String spreadsheet, String worksheet, int spreadsheetIndex, int worksheetIndex)
            throws IOException, ServiceException {
    ...
    private URL getCellFeedUrl(String spreadsheet, String worksheet, int spreadsheetIndex, int worksheetIndex) throws IOException, ServiceException {
